# GeoAI SimKit 1.4.0 Beta-2 Template Tutorial — 边坡稳定分阶段降雨 Beta Demo
...
## 工程问题
坡脚扰动和水位变化后，塑性区、位移和有效应力响应是否提示失稳风险？
...
## Acceptance
- Project: `GeoAI SimKit 1.4.0 Beta-2 边坡稳定分阶段降雨 Beta Demo`
- Demo: `slope_stability_beta`
